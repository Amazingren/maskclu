...
class S3DISDatasetHDF5(Dataset):
    ...
    def __init__(self, root, split='train', test_area=5):
        if root is None:
            root = 'datasets/indoor3d_sem_seg_hdf5_data'
        self.root = root
...
if __name__ == '__main__':
    data_root = '/datasets/gmei/datasets/stanford_indoor3d/'
    ...
    print('point datasets size:', point_data.__len__())
    print('point datasets 0 shape:', point_data.__getitem__(0)[0].shape)
